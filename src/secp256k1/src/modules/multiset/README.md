...
-----
    ...
    // Construct a multiset of (data1,data2,data3) and
    // remove (data2)
    ...
    secp256k1_multiset_add(context, &x, data1, sizeof(data1));
    secp256k1_multiset_add(context, &x, data2, sizeof(data2));
    secp256k1_multiset_add(context, &x, data3, sizeof(data3));

    // remove data2
    secp256k1_multiset_remove(context, &x, data2, sizeof(data2));

    // convert to hash
    secp256k1_multiset_finalize(context, hashResult, &x);
