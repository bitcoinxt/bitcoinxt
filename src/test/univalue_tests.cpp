...
BOOST_AUTO_TEST_CASE(univalue_set)
{
    ...
    BOOST_CHECK_EQUAL(v.size(), size_t(0));
...
BOOST_AUTO_TEST_CASE(univalue_array)
{
    ...
    BOOST_CHECK_EQUAL(arr.size(), size_t(5));
    ...
    BOOST_CHECK_EQUAL(arr.size(), size_t(0));
}
...
BOOST_AUTO_TEST_CASE(univalue_object)
{
    ...
    BOOST_CHECK_EQUAL(obj.size(), size_t(9));
    ...
    BOOST_CHECK_EQUAL(obj.size(), size_t(0));
}
...
BOOST_AUTO_TEST_CASE(univalue_readwrite)
{
    ...
    BOOST_CHECK(v.isArray());
    BOOST_CHECK_EQUAL(v.size(), size_t(2));

    BOOST_CHECK_EQUAL(v[0].getValStr(), "1.10000000");

    UniValue obj = v[1];
    BOOST_CHECK(obj.isObject());
    BOOST_CHECK_EQUAL(obj.size(), size_t(3));
